...
namespace MTProject
{
    public class Parser
    {
        ...
        {
            IdentToken id = new IdentToken(1, 1, "main");
            IdentToken name = new IdentToken(1,1,"main");
        ...
        public bool IsCompoundSt()
        {
            ...
            if (CheckSpecialSymbol("{"))
            {
                Warning("Compound statement found ");
                while (IsDeclaration()) ;
        ...
        public bool IsFuncDefOrVarDef()
        {
			...
			*/
            ...
            Warning("successfully added variable " +type.ToString()+" "+ name.value);
